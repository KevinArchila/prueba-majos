    ...
    if id_puesto == "inicio":
        ...
        if request.method == "POST":
            ...
            if limpieza_select is not None: 
                registrar_limpieza = Registro_limpieza(fecha = fecha_actual, horario = horario, estado = "True", limpieza_puestos_id = limpieza_select, usuario_id = perfil, usuario_servicio_id = usuario_servicio_id)
