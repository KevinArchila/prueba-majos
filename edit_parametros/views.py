...
def edit_limpieza(request, id_limpieza):
    ...
    puestos = Puestos.objects.filter(usuario_servicio = usuario_servicio_id)
    ...
    if request.method == "POST":
        ...
        usuario_servicio_id = request.session.get("usuario_id")
        limpie_existe = Limpieza_puestos.objects.exclude(nombre_limpieza = limpieza_edit.nombre_limpieza, estado = "True", usuario_servicio = usuario_servicio_id) 
        nombre_existen = []
...
def edit_freidora(request, id_freidora):
    ...
    if request.method == "POST":
        ...
        freidora_existe = Registro_objetos.objects.exclude(nombre_objeto = freidora_edit.nombre_objeto, usuario_servicio = usuario_servicio_id, estado = "True", servicio = "Operativo").exclude(servicio = "Fuera de servicio", estado = "False") 
        nombre_existen = []
...
def edit_nevera(request, id_nevera):
    ...
    if request.method == "POST":
        ...
        nevera_existe = Registro_objetos.objects.exclude(nombre_objeto = nevera_edit.nombre_objeto, tipo_objeto = "Nevera", usuario_servicio = usuario_servicio_id, estado = "True", servicio = "Operativo").exclude(servicio = "Fuera de servicio") 
        nombre_existen = []
...
def edit_puesto(request, id_puesto):
    ...
    if request.method == "POST":
        ...
        puesto_existe = Puestos.objects.exclude(nombre_puesto = puesto_edit.nombre_puesto, estado = "True", usuario_servicio = usuario_servicio_id)
        nombre_existen = []
...
def delet_puesto(request, id_puesto):
    eliminar_puesto = Puestos.objects.filter(id = id_puesto).first()
...
def edit_cargo(request, id_cargo):
    ...
    if request.method == "POST":
        ...
        cargo_existe = Cargo_usuarios.objects.exclude(nombre_cargo = cargo_edit.nombre_cargo, estado = "True", usuario_servicio = usuario_servicio_id)
        nombre_existen = []
...
def edit_perfil(request, id_perfil):
    ...
    if request.method == "POST":
        ...
        perfil_existe = Usuarios.objects.exclude(nombre = perfil_edit.nombre, estado = "True", usuario_servicio = usuario_servicio_id)
        nombre_existen = []
